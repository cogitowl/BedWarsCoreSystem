...
execute unless entity @s[type=marker,tag=playing_center] run function bw:game_start/system_init/pre_init
execute unless entity @s[type=marker,tag=playing_center] as @e[type=marker,tag=playing_center] if score @s map = $using map at @s run return run function bw:game_start/final_start
...
function bw:game_start/system_init/select_player
...
function bw:game_start/system_init/team_join
...
execute unless score $working mutation = $working mutation run function bw:game_start/system_init/mutation_get
...
function bw:game_start/system_init/mutation_name_process with storage bw:basic mutation
...
# 加载强加载区块
function bw:game_start/system_init/forceload with storage bw:map using.border
...
# 倒计时开始
function bw:game_start/system_init/game_start_countdown