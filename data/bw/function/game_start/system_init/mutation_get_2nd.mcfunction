#> bw:game_start/system_init/mutation_get_2nd
# 获得随机事件编号
...
execute if score $working mutation matches 0 run function bw:game_start/system_init/mutation_get_2nd_loop with storage bw:basic mutation
