...
summon marker ~ 0 ~ {Tags:["res","res_diamond","sys_editing"]}
...
data modify storage bw:basic temp.Pos.x set from storage bw:map using.spawner.diamond[0][0]
data modify storage bw:basic temp.Pos.y set from storage bw:map using.spawner.diamond[0][1]
data modify storage bw:basic temp.Pos.z set from storage bw:map using.spawner.diamond[0][2]
...
data remove storage bw:map using.spawner.diamond[0]
