...
# 发送参数传递内容
execute if score $printer_transfer bug_tracker_temp matches 0.. run function debug:bug_tracker/printer/lobby/message with storage debug:bug_tracker/printer

# loop
execute if score $printer_transfer bug_tracker_temp matches 1.. run function debug:bug_tracker/printer/lobby/loop_body