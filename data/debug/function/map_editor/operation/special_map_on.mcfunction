...
# nbt
$data modify storage bw:map maps[{"id":$(id)d}].additional.special_map.on set value true

# id
$function debug:map_editor/operation/id/reverse {"nbt":"maps[{'id':$(id)d}]","storage":'bw:map'}
